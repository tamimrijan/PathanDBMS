...
<body>
    ...
    <div class="register-container">
        <a href="../index.php"><img src="final.png" alt="Logo" /></a>
        <h2>Register</h2>
        ...
        <form action="" method="post">
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" class="form-control" placeholder="ig. Tamim and Farzana" required>
            </div>
            <div class="form-group">
                <label for="ph">Phone Number</label>
                <input type="number" id="ph" name="ph" class="form-control" placeholder="+8801......" required>
            </div>
            <div class="form-group">
                <label for="email">Email Address</label>
                <input type="email" id="email" name="email" class="form-control" placeholder="এই ইমেইল এ কিন্তু OTP পাঠানো হবে তাই সঠিক মেইল দিন"required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="password" id="confirm_password" name="confirm_password" class="form-control" placeholder="পাসওয়ার্ড আবার মারেন"required>
            </div>
            <div class="form-group">
